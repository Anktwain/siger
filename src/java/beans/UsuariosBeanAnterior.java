 ...
 * @since SigerWeb2.0
 */
@ManagedBean(name = "usuariosBeanAnterior")
@ViewScoped
public class UsuariosBeanAnterior implements Serializable {
...
//  private List<PerfilBean> listaPerfiles;
  ...
  public UsuariosBeanAnterior() {
    ...
    gestoresNoConfirmados = usuarioDao.buscarUsuariosNoConfirmados(usuario.getDespacho().getIdDespacho());
